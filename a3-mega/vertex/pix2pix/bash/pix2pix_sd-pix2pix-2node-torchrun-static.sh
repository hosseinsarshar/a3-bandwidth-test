...
python -c "print('******* Instruct_Pix2Pix training starts *******')"
...
# MASTER_ADDR is set by Vertex with the address of Worker 0
# MASTER_PORT will default to 2222
# RANK will be node rank (0,1,2,3, etc.) depending on the VM
